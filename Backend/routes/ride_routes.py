...
from controllers.ride_controller import create_ride_api, get_fare_api, confirm_ride_api, start_ride_api, end_ride_api, get_ride_history_api, get_favorite_locations, get_captain_ride_history_api
...
ride_bp.route('/captain-ride-history', methods=['GET'])(get_captain_ride_history_api)